...
app_info = {'name': 'lensoftruth.js',
            ...
            'description': 'jQuery has as very powerful data API to store values and JavaScript objects on nodes in the DOM. These attributes are not directly visible in the DOM, so they can be hard to debug. The lensoftruth.js jQuery plugin fixes that by adding visible data attributes while debugging.',
